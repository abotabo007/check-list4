...
c1 = [
    ["gloves", "gloves_t", "gloves_b", "Guanti (Insulating gloves)"],
    ["extra3", "extra3_t", "extra3_b", "Ambu"],
    ["extra4", "extra4_t", "extra4_b", "DAE"],
    ["extra5", "extra5_t", "extra5_b", "Carta"],
    ["extra6", "extra6_t", "extra6_b", "Sondini"]
]